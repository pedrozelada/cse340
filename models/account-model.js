...
async function checkExistingEmail(account_email){
  ...
  /* **********************
 *   Check for existing email and Id
 * ********************* */
  async function checkExistingEmaild(account_id, account_email){
    try {
      const sql = "SELECT * FROM account WHERE account_email = $2 AND account_id != $1"
